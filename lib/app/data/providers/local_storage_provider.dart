...
class LocalStorageProvider {
  ...
  bool hasCompletedInduction(String userId) {
    final Map<String, dynamic>? inductionData = _box.read(
      _keyInductionCompleted,
    );
  ...
  Future<void> markInductionCompleted(String userId) async {
    final Map<String, dynamic> inductionData =
        _box.read(_keyInductionCompleted) ?? {};
  ...
  Future<void> saveWatchedVideos(List<String> list) async {}

  Future<void> clearWatchedVideos() async {}

  Future<void> updateCurrentUser(updatedUser) async {}

  getReadNotifications() {}

  Future<void> saveReadNotifications(List<String> list) async {}
}
